				...
				constructGrid : function(){
					...
					if(dtGridReflectionObj.option.check){
						$('#dt_grid_'+gridId+'_check').click(function(e){
							$('input[id*=dt_grid_'+gridId+'_check_]').attr('checkedParam', this.checkedParam);
							if(dtGridReflectionObj.option.onCheck){
...
//					});
				...
				print : function(){
					...
					content += '					<thead>';
					content += '						<tr>';
					content += '							<th><input type="checkbox" id="dt_grid_print_check_'+dtGridReflectionObj.option.id+'" checkedParam="checkedParam" /></th>';
					...
					for(var i=0; i<dtGridReflectionObj.option.columns.length; i++){
						...
						content += '						<td><input type="checkbox" id="dt_grid_print_check_'+dtGridReflectionObj.option.id+'_'+i+'" checkedParam="checkedParam" value="'+i+'" /></td>';
					...
					$('#dt_grid_print_check_'+dtGridReflectionObj.option.id).click(function(){
						$('input[id*=dt_grid_print_check_'+dtGridReflectionObj.option.id+'_]').attr('checkedParam', this.checkedParam);
					});
					//绑定上移方法
					...
					$('#dt_grid_print_execute_'+dtGridReflectionObj.option.id).click(function(){
						...
						if(dtGridReflectionObj.option.showHeader!=false){
							content += '<thead>';
							content += '	<tr>';
							$('input[id*=dt_grid_print_check_'+dtGridReflectionObj.option.id+'_]:checkedParam').each(function(){
				...
				exportFile : function(exportType){
					...
					content += '								<label><input type="radio" name="dt_grid_export_export_all_data_'+exportType+'_'+dtGridReflectionObj.option.id+'" value="0" checkedParam="checkedParam" /> '+$.fn.DtGrid.lang[dtGridReflectionObj.option.lang]['export'][exportType].exportType.now+'</label>';
					...
					content += '					<thead>';
					content += '						<tr>';
					content += '							<th><input type="checkbox" id="dt_grid_export_check_'+exportType+'_'+dtGridReflectionObj.option.id+'" checkedParam="checkedParam" /></th>';
					...
					for(var i=0; i<dtGridReflectionObj.option.columns.length; i++){
						...
						content += '						<td><input type="checkbox" id="dt_grid_export_check_'+exportType+'_'+dtGridReflectionObj.option.id+'_'+i+'" checkedParam="checkedParam" value="'+i+'" /></td>';
						content += '						<td>'+column.title+'</td>';
						content += '						<td>';
					...
					$('#dt_grid_export_check_'+exportType+'_'+dtGridReflectionObj.option.id).click(function(){
						$('input[id*=dt_grid_export_check_'+exportType+'_'+dtGridReflectionObj.option.id+'_]').attr('checkedParam', this.checkedParam);
					});
					//绑定上移方法
					...
					$('#dt_grid_export_execute_'+exportType+'_'+dtGridReflectionObj.option.id).click(function(){
						...
						dtGridPager.exportAllData = $('input[name*=dt_grid_export_export_all_data_'+exportType+'_'+dtGridReflectionObj.option.id+']:checkedParam').val()=='1'?true:false;
						...
						$('input[id*=dt_grid_export_check_'+exportType+'_'+dtGridReflectionObj.option.id+'_]:checkedParam').each(function(){
				...
				getCheckedRecords: function(){
					...
					$('input[id*=dt_grid_'+dtGridReflectionObj.option.id+'_check_]:checkedParam').each(function(){
